...
public class Apriori12 extends Observable {
 
 
public static void main(String[] args) throws Exception {
Apriori12 ap = new Apriori12(args);
ap.writer.close();
}
...
//private File file1 =  new File (args[2]);
public PrintWriter writer = new PrintWriter ("Rohit1.txt","UTF-8"); 
public Apriori12(String[] args, Observer ob) throws Exception
{
usedAsLibrary = true;
configure(args);
this.addObserver(ob);
...
public Apriori12(String[] args) throws Exception
{
...
writer.println(Arrays.toString(itemset) + " ("+ ((support / (double) numTransactions))+" "+support+")");
}
}
